...
import { X, CheckCircle, BookOpen, CircleCheck, Clock, Video, Activity, AlertTriangle } from "lucide-react"
import { useState, useEffect } from "react"

export default function ModuleDetailModal({ module, quizState, progress, onClose, onQuizStart, onAnswer, fireConfetti }) {
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2 text-purple-500">
                        <span className="font-semibold">
                          Question {quizState.questionIndex + 1}/{module.quiz.length}
                        </span>
                        <div className="w-12 h-1 bg-gray-200 rounded-full overflow-hidden">
                          <motion.div
                            className="h-full bg-purple-500"
                            initial={{ width: 0 }}
                            animate={{ width: `${((quizState.questionIndex + 1) / module.quiz.length) * 100}%` }}
                      ...
                      <div className="flex items-center gap-2 text-amber-500">
                        ...
                        <span className="font-medium">{quizState.score} XP</span>
                      </div>
                    </div>
