        ...
        <div className="container mx-auto px-4 py-8">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-sky-300">
                    Track your moods, unlock patterns, and embrace your emotional journey with
                    AI-driven insights!
                  </p>
                </div>
              </motion.div>
          ...
          {showMoodHistory ? (
            ...
            >
                      ...
                      datasets: [
                        {
                          ...
                          backgroundColor: moodEntries.map((entry) =>
                            `hsl(${entry.mood.color.replace(/[^\d,]+/g, '')}, 1)`
                          ),
                          borderRadius: 5,
                          borderSkipped: false,
                        },
              ...
              >
                <h3 className="text-lg font-semibold text-white mb-2">AI-Driven Insight:</h3>
                ...
                {moodEmojis.map((mood, index) => (
                  <motion.button
                    ...
                    className={`p-4 rounded-lg shadow-sm transition-colors ${
                      currentMood === mood && 'ring-2 ring-teal-500'
                    }`}
