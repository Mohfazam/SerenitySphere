...
export const ChatBot: React.FC = () => {
  ...
  // Keep all the existing code for navigation, features, animations, etc.
  ...
  // Keep all the existing animation variants
  ...
  // Keep all the existing handlers and functions
                ...
                <ChatMessage
                  ...
                  quickReplies={
                    message.role === 'assistant'
                      ? ['Tell me more', 'What should I do?', 'I need advice']
                      : undefined
                  }
