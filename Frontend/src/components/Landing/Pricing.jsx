...
export const Pricing = () => {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col bg-slate-50 dark:bg-slate-900">
      <div className="absolute inset-0 w-full h-full bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-black pointer-events-none" />
